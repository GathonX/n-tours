...
export default function DestinationPage() {
  ...
  // Recherche par slug, ou fallback sur id numérique
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link href="/reservation">
                <a className="inline-block bg-white hover:bg-gray-100 text-primary font-medium px-8 py-3 rounded-full transition-colors">
                  Réserver maintenant
                </a>
              </Link>
              <Link href="/contact">
                <a className="inline-block border-2 border-white text-white hover:bg-white/10 font-medium px-8 py-3 rounded-full transition-colors">
                  Nous contacter
                </a>
              </Link>
            </div>
